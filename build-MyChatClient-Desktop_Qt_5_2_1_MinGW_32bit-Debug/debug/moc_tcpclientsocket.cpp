...
#include "../../MyChatClient/tcpclientsocket.h"
...
QT_MOC_LITERAL(5, 59, 14)
    ...
    "TcpClientSocket\0dealMessage\0\0"
...
void TcpClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->dealMessage((*reinterpret_cast< QMap<QString,QString>(*)>(_a[1]))); break;
        ...
        {
            typedef void (TcpClientSocket::*_t)(QMap<QString,QString> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpClientSocket::dealMessage)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void TcpClientSocket::dealMessage(QMap<QString,QString> _t1)
{
